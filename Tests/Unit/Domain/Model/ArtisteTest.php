...
{
    /**
     * @var \AGNM\ExpositionAgNm\Domain\Model\Artiste
     */
    ...
    {
        parent::setUp();
        $this->subject = new \AGNM\ExpositionAgNm\Domain\Model\Artiste();
    }
    ...
    {
        $nationalite = new \AGNM\ExpositionAgNm\Domain\Model\Nationalite();
